...
export const Phone = ({ width, height, fill }: IconProps) => (
  <svg fill={fill} width={width} height={height} version="1.1" viewBox="0 0 15.54 27.442" xmlns="http://www.w3.org/2000/svg">
